...
export const LIVE_ITEMS = Object.freeze([...range(101, 108), ...range(201, 205), ...range(301, 307), ...range(321, 324), ...range(401, 405), ...range(501, 508), "601", ...range(603, 605), ...range(701, 708), ...range(801, 820), ...range(901, 905)]);
