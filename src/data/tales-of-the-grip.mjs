export const talesStrips = Object.freeze([
	...
	Object.freeze({
		status: "published",
		stripNumber: 201,
		slug: "true-agility-now-faster",
		path: "/tales-of-the-grip/true-agility-now-faster",
		title: "True Agility. Now Faster.",
		datePublished: "2026-09-22",
		dateLabel: "September 22, 2026",
		imageAlt: "Tales of the Grip strip titled True Agility. Now Faster. A leader says they simplified Scrum with AI while a happy cloud speeds stickies from Ideas through Build and Test. Release backs up, then collapses into a pile. She says more is better. A colleague answers that they were almost out of waiting.",
		seoDescription: "True Agility. Now Faster. A Tales of the Grip editorial cartoon about organizational execution.",
		socialImage: Object.freeze({
			src: "/social/tales-of-the-grip/true-agility-now-faster.png",
			width: 1600,
			height: 2400,
			type: "image/png",
		}),
	...
	Object.freeze({
		status: "published",
		stripNumber: 200,
		slug: "we-removed-the-role",
		path: "/tales-of-the-grip/we-removed-the-role",
		title: "We Removed the Role",
		datePublished: "2026-09-21",
		dateLabel: "September 21, 2026",
		imageAlt: "Tales of the Grip strip titled We Removed the Role. A leader says the Scrum Master role is gone and the team is self-managing with ArtI. The team asks who facilitates, follows blockers, protects the work, and keeps people coordinated. She says the team absorbed those jobs while Cal is on the phone. The last panel asks when Cal gets back. His out-of-office says he is on vacation.",
		seoDescription: "We Removed the Role. A Tales of the Grip editorial cartoon about organizational execution.",
		socialImage: Object.freeze({
			src: "/social/tales-of-the-grip/we-removed-the-role.png",
			width: 1600,
			height: 2400,
			type: "image/png",
		}),
	...
	Object.freeze({
		status: "published",
		stripNumber: 202,
		slug: "virtual-product-training-for-customers",
		path: "/tales-of-the-grip/virtual-product-training-for-customers",
		title: "Virtual Product Training for Customers",
		datePublished: "2026-09-20",
		dateLabel: "September 20, 2026",
		imageAlt: "Tales of the Grip strip titled Virtual Product Training for Customers. A trainer asks Ken to turn on his camera for a check-in. Ken appears without a shirt. A one-star review from Ken is then posted as a company campaign titled We Will Call You Out. A leader says they will make sure customers learn.",
		seoDescription: "Virtual Product Training for Customers. A Tales of the Grip editorial cartoon about organizational execution.",
		socialImage: Object.freeze({
			src: "/social/tales-of-the-grip/virtual-product-training-for-customers.png",
			width: 1600,
			height: 2400,
			type: "image/png",
		}),
