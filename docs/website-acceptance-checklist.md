...
| 002 | Affected | Agent | The complete `docs/brand/source/3Back-Minimum-Viable-Brand-and-Design-Brief.md` is the sole governing brand and design brief for outward-facing content, positioning, navigation, hierarchy, interaction, and visual design. Agents must not read, convert, or render any DOCX version. | When any listed area is affected, read the complete Markdown brief before editing and compare the result with it. |
| 003 | Affected | Agent | Page-specific source material may add constraints but may not override `docs/brand/source/3Back-Minimum-Viable-Brand-and-Design-Brief.md` or this publication checklist. | Identify applicable page sources and check their scope and status. Prototype-only exceptions do not become publication requirements. |
...
| 107 | Affected | Agent | Visual expression remains editorial, spacious, restrained, typography-led, and grounded in real work, boundaries, flow, and cause and effect. | Inspect the affected desktop and mobile rendering against the complete `docs/brand/source/3Back-Minimum-Viable-Brand-and-Design-Brief.md`. |
