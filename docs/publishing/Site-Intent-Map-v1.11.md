...
**Version:** 1.11
**Date:** 2026-09-17
**Scope:** record live SGO course pages, Scaling Scrum with Scrum, Recognized Scrum Guide Stage 1, Scrum for Teams, the `/courses` last-band rewrite, and the current header conversation exception list
