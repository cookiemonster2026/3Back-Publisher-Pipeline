...
**Version:** 1.7  
**Date:** 2026-09-09  
**Scope:** record the staff `/docs` set, the client-error history page, and the privacy diagnostic disclosure  
...
| **Gate** | Public-by-URL. No passphrase. |
| **Groups** | Work: Backlog, Publisher Role, Acceptance checks, Client errors. Technical: Technical Manifest, AGENTS, Contact form, LMS, Sitemap. Marketing: Brand brief, Visual Direction, Site Intent Map, Appendix A: SA Exception. |
| **Sitemap link** | `https://3back.com/sitemap-index.xml`. Not `/sitemap.xml`. |
| **Non-goals** | Not a public library. Not a second source of truth. Not Cloudflare Access this pass. |
