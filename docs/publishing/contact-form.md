...
The Scrum for Teams private inquiry form posts to `/api/sft-private-inquiry` and uses `sft-private@3back.com` for notifications and confirmations. The Scrum Mastering I private inquiry form posts to `/api/sm1-private-inquiry` and uses `rsm1-private@3back.com` for notifications and confirmations. The Scrum Mastering II private inquiry form posts to `/api/sm2-private-inquiry` and uses `rsm2-private@3back.com` for notifications and confirmations. The Scrum Mastering III private inquiry form posts to `/api/sm3-private-inquiry` and uses `rsm3-private@3back.com` for notifications and confirmations. The Product Ownership I private inquiry form posts to `/api/po1-private-inquiry` and uses `rpo1-private@3back.com` for notifications and confirmations. The Product Ownership II private inquiry form posts to `/api/po2-private-inquiry` and uses `rpo2-private@3back.com` for notifications and confirmations. The Product Ownership III private inquiry form posts to `/api/po3-private-inquiry` and uses `po3@3back.com` for notifications and confirmations. The Scaling Scrum with Scrum private inquiry form posts to `/api/ssws-private-inquiry` and uses `ssws-private@3back.com` for notifications and confirmations. All eight use the same Turnstile and Resend configuration described below.
