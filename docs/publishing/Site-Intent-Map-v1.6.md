...
**Version:** 1.6  
**Date:** 2026-09-08  
**Scope:** record Domain Guides as the program conversation funnel; record Why Domain Expertise Matters as the argument sibling; record the header conversation exception on pages that already have a form  
