...
**Version:** 1.0  
**Date:** 2026-08-16  
**Scope:** Minimal releasable site as of test.3back.com review  
...
| **Current state** | Stub; **noindex, nofollow**; H1 STUB |
...
Do not treat `/ideas` as a finished public destination until Stage gates complete and noindex is lifted.
...
|---|---|
| **Ideas hub** | Replace `/ideas` stub with real written-work hub (papers, posts, books). Lift noindex. Recast old white papers and posts through OG lens; incomplete recasts stay off the hub. |
| **Ideas content runway** | Editorial backlog under OG: refreshed papers, new posts, book paths. Not a news wire; not infographics; not company P&L dissection series. |
| **Tales of the Grip production** | Cast, organization world, weekly strip + animated adaptation; sample already on Doomscroll. Episodes publish into Doomscroll, not into Ideas. |
| **Course catalog depth** | Individual course surfaces (~30) as stubs then full pages; badge assets; A-CSM / CSP paths remain on path.3back.com where already decided. |
| **Expert Echo AI courses** | Move Training “Coming Soon” to a real offer when product is ready; request-to-learn-more is only a bridge. |
| **Homepage residual polish** | Any remaining interaction, mobile, or Current Thinking residuals not closed before minimal release. |
| **Legacy redirect completion** | Full `/insights` and related URL map → Ideas / paper routes / Doomscroll as appropriate. |
| **CRM handoff** | Form and paper metadata already shaped for Pipedrive (or similar). Tool choice and pipeline wiring are a later ops epic, not a page epic. |

**Not backlog (explicit non-goals)**

- Company public P&L hit-piece series  
- Infographic library as a destination  
- Membership / login wall for papers  
- Treating 3Back primarily as an Agile/Scrum training company  
...
| Version | Date | Notes |
|---|---|---|
| 1.0 | 2026-08-16 | First full map for minimal releasable site; includes paper gate and Doomscroll; Ideas marked stub; backlog epics section |

---

*End of Site Intent Map v1.0*
